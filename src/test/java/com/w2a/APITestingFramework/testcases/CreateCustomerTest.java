...
import com.w2a.APITesingFramewrok.APIs.CreateCustomerAPI;
...
public class CreateCustomerTest extends BaseTest{
	...
	public void validateCreateCustomerAPIWithValidSecretKay(Hashtable<String,String> data) {
	...
	@Test(dataProviderClass=DataUtil.class, dataProvider="data" )
	public void validateCreateCustomerAPIWithInValidSecretKay(Hashtable<String,String> data) {
